...
<html lang="en">
  <head>
    ...
    <!-- Custom - CSS Include -->
    <link rel="stylesheet" type="text/css" href="/public/frontend-assets/css/style.css?v=11" />
    <link rel="stylesheet" type="text/css" href="/public/frontend-assets/css/custom.css?v=11" />
  </head>
  ...
  <body class="financial_consulting africapay africapay-0 inner-page-s1">
    ...
    <script src="/public/frontend-assets/js/custom.js?v=11"></script>
  </body>
</html>
